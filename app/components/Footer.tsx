...
const SOCIALS = [
  { icon: <IconInstagram />, href: 'https://instagram.com/antonail',    label: 'Instagram' },
  { icon: <IconTikTok />,    href: 'https://tiktok.com/@antonail',      label: 'TikTok' },
...
export function Footer() {
  ...
  return (
    <footer style={{ background: 'var(--white)' }}>
      ...
      {/* Main columns */}
      <div style={{ maxWidth: '1400px', margin: '0 auto', padding: 'clamp(40px, 6vw, 80px) clamp(20px, 5vw, 48px) clamp(32px, 5vw, 64px)' }}>
        <div className="footer-grid" style={{ display: 'grid', gridTemplateColumns: '1.4fr 1fr 1fr 1.4fr', gap: '48px' }}>
          ...
          <div>
            ...
            <ul style={{ listStyle: 'none', margin: 0, padding: 0, display: 'flex', flexDirection: 'column', gap: '12px' }}>
              {[
                { label: 'Mes avis clients',     href: '#avis' },
                { label: 'Mes prestations',      href: '#prestations' },
                { label: 'Questions fréquentes', href: '#faq' },
                { label: 'Prendre RDV',          href: '#contact' },
              ].map((item) => (
                <li key={item.label}>
                  <a href={item.href} className="footer-link" style={{
          ...
          <div>
            <p style={{
              fontFamily: 'var(--font-dm-sans)', fontSize: '13px', fontWeight: 700,
              color: 'var(--noir)', margin: '0 0 14px',
            }}>
              Prestations
            </p>
            <ul style={{ listStyle: 'none', margin: 0, padding: 0, display: 'flex', flexDirection: 'column', gap: '12px' }}>
          ...
          <div>
            ...
            <ul style={{ listStyle: 'none', margin: 0, padding: 0, display: 'flex', flexDirection: 'column', gap: '12px' }}>
              {['Dakar, Sénégal', 'Sur rendez-vous uniquement'].map((text) => (
                <li key={text}>
                  <span style={{
                    fontFamily: 'var(--font-dm-sans)', fontSize: '13px', fontWeight: 400,
                    color: 'var(--noir)',
      ...
      <div style={{ borderTop: '1px solid rgba(0,0,0,0.08)' }}>
        <div style={{
          maxWidth: '1400px', margin: '0 auto', padding: '20px clamp(20px, 5vw, 48px)',
