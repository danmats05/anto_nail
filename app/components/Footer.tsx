...
const SOCIALS = [
  ...
  {
    icon: <IconTikTok />,
    href: "https://tiktok.com/@antonail",
    label: "TikTok",
  },
  {
    icon: <IconSnapchat />,
    href: "https://snapchat.com/add/antonail",
    label: "Snapchat",
  },
];
    ...
    <footer style={{ background: "var(--white)" }}>
      ...
      <div
        style={{
          ...
          margin: "0 auto",
          padding:
            "clamp(40px, 6vw, 80px) clamp(20px, 5vw, 48px) 8px",
        }}
      >
        <div
        ...
        >
          ...
          <div>
            ...
            >
              Prothésiste ongulaire indépendante à Dakar. Je crée des poses gel,
              du nail art et des soins sur-mesure, chaque résultat est pensé
              pour vous.
            </p>
